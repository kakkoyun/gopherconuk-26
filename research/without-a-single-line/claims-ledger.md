...
### [C-011] OBI requires Linux kernel ≥ 5.8 with BTF; six always-required capabilities
- **Verdict:** CONFIRMED
- **Source(s):** S-OBI-04 (official docs, last modified 2026-07-20), S-OBI-06 (SUPPORT_MATRIX.md)
- **Notes:** Kernel 5.8+ with BTF (BTF default since kernel 5.14+ on most distros). RHEL exception: 4.18+ build 348+. Always-required caps: CAP_BPF, CAP_SYS_PTRACE, CAP_NET_RAW, CAP_CHECKPOINT_RESTORE, CAP_DAC_READ_SEARCH, CAP_PERFMON. Conditional: CAP_SYS_ADMIN.
