...
<!-- Sources populated during deep-research phase. -->
<!-- Do not add sources without also adding a corresponding entry in claims-ledger.md. -->
...
- **Accessed:** 2026-07-22
- **Notes:** otelc README; install command; -toolexec usage. Go.mod min version: TODO verify.
